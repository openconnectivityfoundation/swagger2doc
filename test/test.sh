...
my_test_in_dir -docx ../input/ResourceTemplate.docx -resource BinarySwitchResURI -swagger ../test/in/test_swagger_1/test_swagger_1.swagger.json -word_out $OUTPUT_DIR_DOCS/$TEST_CASE/$TEST_CASE.docx
